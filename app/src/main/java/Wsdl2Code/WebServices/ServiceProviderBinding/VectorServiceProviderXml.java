...
public class VectorServiceProviderXml extends Vector<ServiceProviderXml> implements KvmSerializable {
    
    
    public VectorServiceProviderXml(){}
    
    public VectorServiceProviderXml(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    ServiceProviderXml j1= new ServiceProviderXml(j0);
                    add(j1);
                }
            }
        }
