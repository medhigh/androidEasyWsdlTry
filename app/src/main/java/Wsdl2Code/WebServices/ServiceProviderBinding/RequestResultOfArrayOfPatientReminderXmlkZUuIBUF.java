...
//
import Wsdl2Code.WebServices.ServiceProviderBinding.VectorPatientReminderXml;
...
public class RequestResultOfArrayOfPatientReminderXmlkZUuIBUF implements KvmSerializable {
    
    public String errorMessage;
    public VectorPatientReminderXml result;
    public int resultStatus;
    public boolean resultStatusSpecified;
    
    public RequestResultOfArrayOfPatientReminderXmlkZUuIBUF(){}
    
    public RequestResultOfArrayOfPatientReminderXmlkZUuIBUF(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        ...
        if (soapObject.hasProperty("Result"))
        {
            ...
            result = new VectorPatientReminderXml(j);
        }
