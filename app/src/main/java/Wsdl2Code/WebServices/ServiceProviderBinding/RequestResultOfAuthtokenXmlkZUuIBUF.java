...
public class RequestResultOfAuthtokenXmlkZUuIBUF implements KvmSerializable {
    ...
    public RequestResultOfAuthtokenXmlkZUuIBUF(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
