...
//
import Wsdl2Code.WebServices.ServiceProviderBinding.VectorCustomerSurveyXml;
...
public class RequestResultOfArrayOfCustomerSurveyXmlkZUuIBUF implements KvmSerializable {
    
    public String errorMessage;
    public VectorCustomerSurveyXml result;
    public int resultStatus;
    public boolean resultStatusSpecified;
    
    public RequestResultOfArrayOfCustomerSurveyXmlkZUuIBUF(){}
    
    public RequestResultOfArrayOfCustomerSurveyXmlkZUuIBUF(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        ...
        if (soapObject.hasProperty("Result"))
        {
            ...
            result = new VectorCustomerSurveyXml(j);
        }
