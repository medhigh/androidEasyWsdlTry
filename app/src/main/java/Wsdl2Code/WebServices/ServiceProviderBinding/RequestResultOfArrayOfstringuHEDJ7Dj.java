...
public class RequestResultOfArrayOfstringuHEDJ7Dj implements KvmSerializable {
    
    public String errorMessage;
    public VectorString result;
    public int resultStatus;
    public boolean resultStatusSpecified;
    
    public RequestResultOfArrayOfstringuHEDJ7Dj(){}
    
    public RequestResultOfArrayOfstringuHEDJ7Dj(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
