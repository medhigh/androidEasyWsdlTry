...
public class RequestResultOfArrayOfAppointmentXmlkZUuIBUF implements KvmSerializable {
    
    public String errorMessage;
    public VectorAppointmentXml result;
    public int resultStatus;
    public boolean resultStatusSpecified;
    
    public RequestResultOfArrayOfAppointmentXmlkZUuIBUF(){}
    
    public RequestResultOfArrayOfAppointmentXmlkZUuIBUF(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        ...
        if (soapObject.hasProperty("Result"))
        {
            ...
            result = new VectorAppointmentXml(j);
        }
