...
//
import Wsdl2Code.WebServices.ServiceProviderBinding.VectorInfoRecordXml;
...
public class RequestResultOfArrayOfInfoRecordXmlkZUuIBUF implements KvmSerializable {
    
    public String errorMessage;
    public VectorInfoRecordXml result;
    public int resultStatus;
    public boolean resultStatusSpecified;
    
    public RequestResultOfArrayOfInfoRecordXmlkZUuIBUF(){}
    
    public RequestResultOfArrayOfInfoRecordXmlkZUuIBUF(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        ...
        if (soapObject.hasProperty("Result"))
        {
            ...
            result = new VectorInfoRecordXml(j);
        }
