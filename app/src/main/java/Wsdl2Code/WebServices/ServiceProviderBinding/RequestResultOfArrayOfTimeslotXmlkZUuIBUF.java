...
//
import Wsdl2Code.WebServices.ServiceProviderBinding.VectorTimeslotXml;
...
public class RequestResultOfArrayOfTimeslotXmlkZUuIBUF implements KvmSerializable {
    
    public String errorMessage;
    public VectorTimeslotXml result;
    public int resultStatus;
    public boolean resultStatusSpecified;
    
    public RequestResultOfArrayOfTimeslotXmlkZUuIBUF(){}
    
    public RequestResultOfArrayOfTimeslotXmlkZUuIBUF(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        ...
        if (soapObject.hasProperty("Result"))
        {
            ...
            result = new VectorTimeslotXml(j);
        }
