...
//
import Wsdl2Code.WebServices.ServiceProviderBinding.VectorTimeslotPatternXml;
...
public class RequestResultOfArrayOfTimeslotPatternXmlkZUuIBUF implements KvmSerializable {
    
    public String errorMessage;
    public VectorTimeslotPatternXml result;
    public int resultStatus;
    public boolean resultStatusSpecified;
    
    public RequestResultOfArrayOfTimeslotPatternXmlkZUuIBUF(){}
    
    public RequestResultOfArrayOfTimeslotPatternXmlkZUuIBUF(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        ...
        if (soapObject.hasProperty("Result"))
        {
            ...
            result = new VectorTimeslotPatternXml(j);
        }
