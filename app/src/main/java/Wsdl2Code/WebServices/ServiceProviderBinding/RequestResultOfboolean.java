...
public class RequestResultOfboolean implements KvmSerializable {
    ...
    public RequestResultOfboolean(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        ...
        if (soapObject.hasProperty("Result"))
        {
            ...
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                SoapPrimitive j =(SoapPrimitive) obj;
                result = Boolean.parseBoolean(j.toString());
