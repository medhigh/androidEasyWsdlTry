...
//
import Wsdl2Code.WebServices.ServiceProviderBinding.VectorServiceProviderXml;
...
public class RequestResultOfArrayOfServiceProviderXmlkZUuIBUF implements KvmSerializable {
    
    public String errorMessage;
    public VectorServiceProviderXml result;
    public int resultStatus;
    public boolean resultStatusSpecified;
    
    public RequestResultOfArrayOfServiceProviderXmlkZUuIBUF(){}
    
    public RequestResultOfArrayOfServiceProviderXmlkZUuIBUF(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        ...
        if (soapObject.hasProperty("Result"))
        {
            ...
            result = new VectorServiceProviderXml(j);
        }
